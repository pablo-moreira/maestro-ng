export * from './lib/components/restricao/restricao-entidade/restricao-entidade.component';
...
export * from './lib/models/consulta/operador.interface';
export * from './lib/models/consulta/ordenacao.model';
export * from './lib/models/consulta/restricao-operador.enum';
export * from './lib/models/consulta/restricao-padrao.enum';
export * from './lib/models/consulta/restricao.model';
